...
const update = async (e) => {
   ...
   try{
      ...
      const upd = await axios.put(`http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auct/updbid/${Auctionid}`, {bidAmount,id},{withCredentials:true})
