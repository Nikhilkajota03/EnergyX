...
const Auctbids = () => {
  ...
  const getbids = async () => {
    ...
    try {
      const res = await axios.get(
        "http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auct/bids/" + productid
      );
    ...
    try {
      ...
      if (window.ethereum) {
        ...
        setTimeout(()=>{
          ...
          axios.put(`http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auct/status/${productid}`)
  ...
  const Tranaction = async (buyerWallet,  sellerWallet, price , pincode)=>{
    ...
    try {
     const res = axios.post("http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auct/auctra",{buyerWallet,  sellerWallet, price , pincode} )
 ...
 const deleteitem = async (id)=>{
  ...
  try {
     ...
     const deleteitem = await axios.delete(`http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auct/bidDel/${productid}/${id}`)
