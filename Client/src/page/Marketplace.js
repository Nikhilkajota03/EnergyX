...
const Marketplace = () => {
  ...
  const orders = async () => {
    try {
      const allorders = await axios.get(
        "http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/mak/marketord"
      );
      ...
      try {
        ...
        if (window.ethereum) {
          ...
          setTimeout(() => {
            ...
            axios.put(`http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/mak/status/${id}`);
          }, 9000);
  ...
  const Tranaction = async (buyerWallet, sellerWallet, price, pincode) => {
    try {
      const res = axios.post("http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/mak/marktra", {
        buyerWallet,
        sellerWallet,
        price,
        pincode,
  ...
  const deleteitem = async (id) => {
    try {
      const dlt = await axios.delete(
        `http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/mak/delete/${id}`,
