...
const Signin = () => {
  ...
  const deleteProfile = async (e) => {
    ...
    try {
      const deleteprofile = await axios.delete(
        `http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auth/userDel/${id}`
      );
  ...
  const postupdate = async (e) => {
    ...
    try {
      const upd = await axios.put(
        `http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auth/userupd/${id}`,
        data,
  ...
  const getuser = async () => {
    try {
      const users = await axios.get("http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auth/users");
      setusers(users.data);
  ...
  const saveuser = async (e) => {
    ...
    try {
      const res = await axios.post(
        "http://energy-app-7-env.eba-mr4i5q5z.ap-south-1.elasticbeanstalk.com/api/auth/signup",
        data
      );
